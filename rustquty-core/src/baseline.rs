...
impl BaselineWriter {
    ...
    pub fn init(
        ...
        let baseline = Baseline {
            ...
            created_at: crate::util::chrono_now(),
...
mod tests {
    ...
    #[test]
    fn test_baseline_regression_created_at_is_iso8601() {
        use crate::schema::{
            AuditResult, ClippyResult, CollectorStatus, CollectorsSummary, CoverageResult,
            DenyResult, DuplicatesResult, FmtResult, HackResult, LocResult, MutantsResult,
            SizeResult, TestResult,
        ...
        let summary = crate::schema::MetricsSummary {
            ...
            rustquty_version: "0.3.1".to_string(),
            project: crate::schema::ProjectInfo {
                name: "test".to_string(),
                rust_edition: "2021".to_string(),
                workspace_root: "/tmp".to_string(),
        ...
        // created_at must be ISO-8601, not a raw Unix timestamp
        assert!(
        ...
        assert_eq!(
            baseline.created_at.len(),
            20,
            "created_at should be 20 chars: {}",
            baseline.created_at
        );
    }

    #[test]
    fn test_baseline_regression_update_preserves_iso8601() {
        use crate::schema::{
            AuditResult, ClippyResult, CollectorStatus, CollectorsSummary, CoverageResult,
            DenyResult, DuplicatesResult, FmtResult, HackResult, LocResult, MutantsResult,
            SizeResult, TestResult,
        ...
        BaselineWriter::init(&summary, &baseline_path, false).unwrap();
        BaselineWriter::update(&summary, &baseline_path).unwrap();
